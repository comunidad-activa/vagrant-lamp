...
apt-get -y install vim curl build-essential python-software-properties git curl htop python-pip
...
echo "--- Install PHP ---"
apt-get install -y software-properties-common php7.4 libapache2-mod-php7.4 php7.4-curl php7.4-gd php7.4-mcrypt php7.4-mysql php7.4-common php7.4-curl
